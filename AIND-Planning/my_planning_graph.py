...
class PlanningGraph():
        ...
        for action in self.all_actions:
            ...
            if a_node.prenodes.issubset(self.s_levels[level]):
                ...
                for s_node in self.s_levels[level]:
                    # Connects a and s nodes
                    s_node.children.add(a_node)
                    a_node.parents.add(s_node)
                # Creates a new action at current level
    ...
    def add_literal_level(self, level):
        ...
        # Loops through actions of previous levels to determine which one cause the current state
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        # Checks to see if there is a mutual exclusive relationship between previous state nodes
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        NOTE: The PgNode.is_mutex method can tests whether two nodes are mutually exclusive.
        :param node_s1: PgNode_s
        :param node_s2: PgNode_s
        :return: bool
        """
    ...
    def h_levelsum(self) -> int:
        ...
        # Sum of all level cost in each goal
